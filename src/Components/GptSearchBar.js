...
const GptSearchBar = () => {
  ...
  const handleGptSearchClick = async () => {
    const gptQuery =
      ...
      ". Only give me names of 5 movies, which are comma separated like the example result given ahead. Example Result : Inception, Swati Mutyam, Bommarillu, Conjuring";
